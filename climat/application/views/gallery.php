...
<div class="bgded overlay" style="background-image:url('<?php echo base_url("assets/images/demo/backgrounds/planeteB.jpg") ?>')"> 
  ...
  <div class="wrapper row0">
    <div id="topbar" class="hoc clear"> 
      <!-- ################################################################################################ -->
      <p class="fl_left nospace">Aurora</p>
      <p class="fl_right nospace"><a class="btn" href="<?php echo base_url("LoginController/") ?>">Connexion</a></p>
      <!-- ################################################################################################ -->
    </div>
  </div>
  <!-- ################################################################################################ -->
      ...
      <p><a href="<?php echo base_url()?>">Accueil</a></p>
        ...
        <h5>  <header class="heading">Images en relation avec le rechauffement climatique</header> </h5>
          <ul class="nospace clear">
            <?php if(!empty($listeImage)) 
            {
              $counter=0;
              foreach($listeImage as $images)
              { 
             ...
             ?>
            <li class="one_quarter first"><a href="<?php echo base_url("assets/images/demo/gallery/".$images['image']) ?>"><img src="<?php echo base_url("assets/images/demo/gallery/".$images['image']) ?>" alt="<?php $images['image'] ?>"></a><?php echo $images['description'] ?></li>
            <?php
             }
             else {
              
            ?>
            <li class="one_quarter"><a href="<?php echo base_url("assets/images/demo/gallery/".$images['image']) ?>"><img src="<?php echo base_url("assets/images/demo/gallery/".$images['image']) ?>" alt="<?php $images['image'] ?>"></a><?php echo $images['description'] ?></li>
           <?php
               }
               $counter++;
